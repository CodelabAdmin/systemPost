...
<div class="container">
               ...
               <tr>
                  ...
                  <td class="text-center acciones">
                     <div class="content-actions">
                        <button class="btn-accions view" onclick="openModal(
                              '<?php echo $producto['id_product']; ?>',
                              '<?php echo $producto['name']; ?>',
                              '<?php echo addslashes($producto['description']); ?>',
                              '<?php echo $producto['product_price']; ?>',
                              '<?php echo $producto['stock']; ?>',
                              '<?php echo $producto['category']; ?>',
                              '<?php echo $producto['create_at']; ?>'
                               )">
   ...
   <div class="container-pagination">
      ...
      <?php require('./components/Modal/Modal.inventario.php'); ?>

   </div>
   <script>
      // Función para abrir el modal con los detalles del producto
      function openModal(id, nombre, descripcion, precio, stock, categoria, fecha) {
