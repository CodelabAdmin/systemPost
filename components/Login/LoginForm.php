<div class="login-container">
    ...
    <form id="frm" class="login-form">
        <div class="input-group">
            ...
            <div class="password-container">
                <input id="password" class="input-field input-password" type="password" name="password" placeholder="Contraseña" required>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="icon-password-show size-6">
    ...
    <script>
        ...
        const toggleIcon = document.querySelector('.icon-password');
        const toggleIconShow = document.querySelector('.icon-password-show');
        ...
        toggleIcon.addEventListener('click', () => {
            ...
            toggleIconShow.style.display = 'block';
        });
